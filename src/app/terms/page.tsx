...
export default function TermsPage() {
  return (
    <><Header /><main className="min-h-screen bg-ivory pt-28 pb-20"><div className="container-premium max-w-3xl mx-auto">
      ...
      <div className="card-glass p-6 sm:p-8 text-sm text-plum/60 leading-relaxed space-y-4">
        <p>Last updated: June 2026</p>
        <h2 className="font-display text-lg font-bold text-plum">Acceptance of Terms</h2>
        <p>By accessing and using Aditi Fashion Hub, you accept and agree to be bound by these Terms and Conditions.</p>
        ...
        <p>All content on this website, including images, text, and designs, is the property of Aditi Fashion Hub and may not be reproduced without permission.</p>
        <h2 className="font-display text-lg font-bold text-plum mt-6">Limitation of Liability</h2>
        <p>Aditi Fashion Hub shall not be liable for any indirect, incidental, or consequential damages arising from the use of our services or products.</p>
